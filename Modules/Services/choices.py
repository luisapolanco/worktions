...
('La Esperanza N-2', 'La Esperanza N.º 2'),
('Moscú N-2', 'Moscú N.º 2'),
('Popular N-1', 'Popular N.º 1'),
('Popular N-2', 'Popular N.º 2'),
('Santo Domingo Savio N-1', 'Santo Domingo Savio N.º 1'),
('Santo Domingo Savio N-2', 'Santo Domingo Savio N.º 2'),
('San Pablo', 'San Pablo'),
...
('El Raizal', 'El Raizal'),
('El Pomar', 'El Pomar'),
('Manrique Central N-2', 'Manrique Central N.º 2'),
('Manrique Oriental', 'Manrique Oriental'),
('Versalles N-1', 'Versalles N.º 1'),
('Versalles N-2', 'Versalles N.º 2'),
('La Cruz', 'La Cruz'),
('La Honda', 'La Honda'),
('Oriente', 'Oriente'),
('Maria Cano - Carambola', 'Maria Cano - Carambola'),
('San José La Cima N-1', 'San José La Cima N.º 1'),
('San José La Cima N-2', 'San José La Cima N.º 2'),
...
('Sevilla', 'Sevilla'),
('San Pedro', 'San Pedro'),
('Manrique Central N-1', 'Manrique Central N.º 1'),
('Campo Valdés N-1', 'Campo Valdés N.º 1'),
...
('Doce de Octubre N-1', 'Doce de Octubre N.º 1'),
('Doce de Octubre N-2', 'Doce de Octubre N.º 2'),
('Santander', 'Santander'),
('Pedregal', 'Pedregal'),
...
('El Progreso N-2', 'El Progreso N.º 2'),
('El Triunfo', 'El Triunfo'),
('Robledo', 'Robledo'),
('El Volador', 'El Volador'),
('San Germán', 'San Germán'),
('Barrio Facultad de Minas', 'Barrio Facultad de Minas'),
...
('Aures N-1', 'Aures N.º 1'),
('Aures N-2', 'Aures N.º 2'),
...
('Villa de La Iguaná', 'Villa de La Iguaná'),
('La Cuchilla', 'La Cuchilla'),
('La Aurora', 'La Aurora'),
('La Campiña', 'La Campiña'),
('Paraíso', 'Paraíso'),
('Villa Sofía', 'Villa Sofía'),
...
('Esfuerzos de Paz N-1', 'Esfuerzos de Paz N.º 1'),
('Esfuerzos de Paz N-2', 'Esfuerzos de Paz N.º 2'),
('Enciso', 'Enciso'),
...
('Loreto', 'Loreto'),
('Asomadera N-1', 'Asomadera N.º 1'),
('Asomadera N-2', 'Asomadera N.º 2'),
('Asomadera N-3', 'Asomadera N.º 3'),
('Quinta Linda', 'Quinta Linda'),
('La Candelaria', 'La Candelaria'),
('Prado', 'Prado'),
('Jesús Nazareno', 'Jesús Nazareno'),
('El Chagualo', 'El Chagualo'),
('Estación Villa', 'Estación Villa'),
('San Benito', 'San Benito'),
('Guayaquil', 'Guayaquil'),
('Corazón de Jesús - Barrio Triste', 'Corazón de Jesús - Barrio Triste'),
('Calle Nueva', 'Calle Nueva'),
('Perpetuo Socorro', 'Perpetuo Socorro'),
('Barrio Colón', 'Barrio Colón'),
('Las Palmas', 'Las Palmas'),
('Bomboná N-1', 'Bomboná N.º 1'),
('Boston', 'Boston'),
...
('San Javier N-1', 'San Javier N.º 1'),
('San Javier N-2', 'San Javier N.º 2'),
...
('Lalinde', 'Lalinde'),
('Manila', 'Manila'),
('Las Lomas N-1', 'Las Lomas N.º 1'),
('Las Lomas N-2', 'Las Lomas N.º 2'),
('Altos del Poblado', 'Altos del Poblado'),
('El Tesoro', 'El Tesoro'),
('Los Naranjos', 'Los Naranjos'),
('Los Balsos N-1', 'Los Balsos N.º 1'),
('Los Balsos N-2', 'Los Balsos N.º 2'),
('San Lucas', 'San Lucas'),
('El Diamante', 'El Diamante'),
...
('Diego Echavarria', 'Diego Echavarria'),
('La Mota', 'La Mota'),
('El Rincón', 'El Rincón'),
